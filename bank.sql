...
('hope', 'phoenix', 4, 10, 50.17);
	...
	--		Give them a new account balance of 10.00.
		SELECT account_balance, transactions_attempted FROM accounts WHERE transactions_attempted =0;
		SELECT account_balance, transactions_attempted FROM accounts WHERE account_balance =0;
	...
	--8.	Add a new record.
		INSERT INTO accounts (username, city, transactions_completed, transactions_attempted, account_balance) VALUES ('curtismorice', 'france', 5, 5, 9999.00);
